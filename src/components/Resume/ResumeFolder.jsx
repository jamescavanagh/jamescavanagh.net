              ...
              <div className="privacy-nav mb-55">
                <div className="privacy-nav-wrapper">
                  <ul className="nav nav-tabs flex-column" id="privacy-nav" role="tablist">
                    <li>
                      <h3>Resumes</h3>
                      <p>Please Choose Most Relevant</p>
                      <hr></hr>
                    </li>
                    
                    
                    <li className="nav-item" role="presentation">
                      <button className="nav-link active" id="started-tab" data-bs-toggle="tab" data-bs-target="#started" type="button" role="tab" aria-controls="started" aria-selected="true">
                        General
                      </button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button className="nav-link" id="conditions-tab" data-bs-toggle="tab" data-bs-target="#conditions" type="button" role="tab" aria-controls="conditions" aria-selected="false">
                        Data Analysis Resume
                      </button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button className="nav-link" id="login-tab" data-bs-toggle="tab" data-bs-target="#login" type="button" role="tab" aria-controls="login" aria-selected="false">
            ...
            <div className="col-xl-8 col-lg-8">
              <div className="privacy-content-wrapper">
                <div className="tab-content" id="privacy-nav-content">
                  <div className="tab-pane fade show active" id="generalResume" role="tabpanel" aria-labelledby="generalResume-tab">
                    <div className="privacy-item mb-55">
                      <h4 className="privacy-title mb-20"><b>Experience</b></h4>
                  ...
                  <div className="tab-pane fade" id="dataAnalysisResume" role="tabpanel" aria-labelledby="dataAnalysisResume-tab">
                    <div className="privacy-item mb-55">
                  ...
                  <div className="tab-pane fade" id="machineLearningResume" role="tabpanel" aria-labelledby="machineLearningResume-tab">
                    <div className="privacy-item mb-55">
                  ...
                  <div className="tab-pane fade" id="job" role="tabpanel" aria-labelledby="job-tab">
                    <div className="privacy-item mb-55">
                      <h4 className="privacy-title mb-20"><b>Want </b>Job</h4>
                      <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
